    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-lg-3">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white fw-semibold" href="{{ route('products.index') }}">
                        <i class="fa-solid fa-store me-1"></i> Products
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link text-white fw-semibold" href="{{ route('home.about') }}">
                ...
                @auth
                <li class="nav-item">
                    <a class="nav-link text-white fw-semibold" href="{{ route('cart.index') }}">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                @guest
                    ...
                    <a href="{{ route('register') }}" class="btn btn-warning fw-semibold px-4">
                        Register
                    </a>
